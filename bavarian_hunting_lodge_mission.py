...
rooms = [
    {
        ...
        "pre_minor_crime": "On one wall sits a painting that immediately catches your eye. It depicts a beautiful garden with idealic fruiting trees, flowers and fauna. The colour and brush work is clearly the work of a master, though you aren't sure which one.",
        "minor_crime": "Looking at the far wall you immedately mark your prize. A masterpeice by Frans Ulm, your favourite impressionist. From a photograph, you have contracted a forgery created and now you set to work replacing the real with the forgery. It takes time and effort, and it pains you to roll up the real work, but once done, you are releaved and extatic. You quickly exit to hide your prize in your room.",
        "post_minor_crime": "On one wall sits a painting that immediately catches your eye for its dullness. It depicts a garden with idealic fruiting trees, flowers and fauna however, he colour is drab and brush strokes amateurish.",
    ...
    },
    {
        ...
        "pre_murder": "The lounge is equiped with beautiful leather chairs by a large fire place, a wine rack and a humidor so large you could almost fit inside.",
        ...
        "witness_pre_murder": "Leaving, you witness %s exiting the smoking lounge with a carpet bag. It clinks slighly as they pass and a cork peaks out of the opening. After they leave, you peak inside the room and see nothing of note save a beautiful, flawless leather arm chair by the fire, inviting you to sit.",
        "witness_post_murder": "Leaving, you witness %s exiting the smoking lounge with a carpet bag. It clinks slighly as they pass and a cork peaks out of the opening. After they leave, you peak inside the room and see nothing of note save a leather arm chair by the fire with a hole punched through it's backing.",
        "clue": "You notice that %s smells strongly of cigar smoke."
    },
    {
        "name": "library",
        "alone": "You venture to the library at %d o'clock alone to peruse some of it's impressive collection. It's tall east windows must provide an impressive morning view.",
        "group": "You head to the library at %d o'clock with %s and %s to gawk at it's impressive collection. It's tall east windows must provide an impressive morning view.",
        ...
        "minor_crime": "You have come to steal a rare first edition of Frankenstein that you have heard rumor is among the collection. You scroll up and down the walls of books but it's nowhere to be found. Finally, across the room you see a glass case with the first edition sitting alone on display. Clearly this is a prized possession, but not one the owner expects a guest to steal as the case is unlocked. You open the case, marvel at your prize and replace the original with a reprint. You exit quickly, not to linger around the scene.",
        ...
        "witness_post_murder": "On your way down the hall, you notice %s, climbing a ladder in the far corner of the library from it's entrance. A few moments later they decend, turn and open a glass case.",
